...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'evologics_ros_sync' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/antoni/robot_ws/install/${idir}'.  Ask the maintainer 'ericguerrero <ericguerrero@todo.todo>' to fix it.")
    endif()
