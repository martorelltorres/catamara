...
(cl:defmethod cl:initialize-instance :after ((m <Setpoints>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Setpoints)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cat_arch-msg:<Setpoints> is deprecated: use cat_arch-msg:Setpoints instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Setpoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cat_arch-msg:header-val is deprecated.  Use cat_arch-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'setpoints-val :lambda-list '(m))
(cl:defmethod setpoints-val ((m <Setpoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cat_arch-msg:setpoints-val is deprecated.  Use cat_arch-msg:setpoints instead.")
  (setpoints m))
